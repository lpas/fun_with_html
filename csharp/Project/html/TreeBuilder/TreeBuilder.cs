...
public class Document(): Node(null) {
    ...
    public bool ParserCannotChangeTheModeFlag = false;
    ...
    private void InsertionModeInitial() {
        switch (token) {
            ...
            case DOCTYPE doctype:
                ...
                if (/* todo not an iframesrcdoc document */ true && document.ParserCannotChangeTheModeFlag is false) {
                    ...
                    if (isLimitedQuirksMode(doctype)) {
            ...
            default:
                ...
                if (/* todo not an iframesrcdoc document */ true) {
                    AddParseError("expected-doctype");
                }
                if (document.ParserCannotChangeTheModeFlag is false) {
                    document.mode = Document.QuirksMode.Quirks;
                }
        ...
        bool isQuirksMode(DOCTYPE doctype) {
            return
        ...
        bool isLimitedQuirksMode(DOCTYPE doctype) {
            ...
            if (doctype.publicId is null) return false;
            return
